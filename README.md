...
I also loved using Inverse Kinematics, allowing the fist to hit the rigidbody of the enemy to make the impacts actually connect its a small detail that goes that extra mile; the use of Rigidbodies and physics was really fun to learn and refining the combat was a blast to do.

Some WIP looks at the development of the Combat System
...
![FOCUS-FinishedDEMO](https://github.com/user-attachments/assets/3a9df35a-1e33-4d66-bde4-f10f214a3bc2)
